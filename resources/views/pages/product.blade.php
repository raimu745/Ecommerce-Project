              ...
              <form action="{{route('product.store')}}" method="Post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" id="inputLastname" placeholder="Slug" name="slug">
                    </div>
                </div>
                
                <div class="form-group">
                   <label >Small Description</label>
                   <textarea class="form-control"   name="sdescription" rows="4" placeholder="Textarea content.."></textarea>
                    </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control"  placeholder="Orignal Price" name="oprice">
                    </div>
                    <div class="col-sm-6">
                        <label for="inputLastname">Selling Price</label>
                        <input type="text" class="form-control" id="inputLastname" placeholder="Last name" name="sprice">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="number" class="form-control" id="inputLastname" placeholder="Quantity" name="qty">
                    </div>
                </div>
               <!-- end check -->
               <div class="form-group">
